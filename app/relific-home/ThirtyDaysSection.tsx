    ...
    <section className="py-16 bg-white">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-[50px] leading-tight font-normal mb-4" style={{color: '#2D1B69'}}>
            Here's what you can achieve with<br className="hidden md:block" /> Relific in just 30 days.
          </h2>
          <a href="#" className="text-[24px] inline-flex items-center gap-1 font-medium" style={{color: '#2D1B69'}}>
            Learn more →
          </a>
        </div>
        ...
        <div className="mb-10 mt-10">
          ...
          <div className="relative flex items-center justify-center mb-8">
            <div className="absolute w-[700px] h-[2px]" style={{backgroundColor: '#E5E7EB'}}></div>
            <div className="absolute w-[700px] flex justify-between">
              <div className="w-3 h-3 rounded-full bg-white border-2" style={{borderColor: '#D1D5DB'}}></div>
              <div className="w-3 h-3 rounded-full bg-white border-2" style={{borderColor: '#D1D5DB'}}></div>
              <div className="w-3 h-3 rounded-full" style={{backgroundColor: '#7985FF'}}></div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-12">
          ...
          >
            <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-4" style={{backgroundColor: '#5563FF'}}>
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
            </div>
            <h4 className="font-semibold text-[16px] mb-2" style={{color: '#2D1B69'}}>Get started.</h4>
            <p className="text-[14px] leading-relaxed" style={{color: '#4B5563'}}>
              Upload your MoUs and Program Proposals. AI-R instantly builds your LFA, TOC, models, KPIs, and budget trackers.
            </p>
          </div>
          ...
          >
            ...
            <h4 className="font-semibold text-[16px] mb-2" style={{color: '#2D1B69'}}>Get comfortable.</h4>
            <p className="text-[14px] leading-relaxed" style={{color: '#4B5563'}}>
              Deploy custom, multi-lingual forms to your field teams via Surve-R. Start collecting offline data with zero training lag.
            </p>
          </div>
          ...
          >
            ...
            <h4 className="font-semibold text-[16px] mb-2" style={{color: '#2D1B69'}}>Go live</h4>
            <p className="text-[14px] leading-relaxed" style={{color: '#4B5563'}}>
              Present your first live, board-ready impact report. Total visibility from beneficiary to community, powered by AI-R.
            </p>
          </div>
        </div>
