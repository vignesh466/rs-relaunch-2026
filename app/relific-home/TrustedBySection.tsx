    ...
    <section className="py-12 sm:py-16 md:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 sm:mb-12">
          <h2 className="text-[24px] sm:text-[28px] md:text-[32px] font-semibold mb-3 sm:mb-4 px-2" style={{ color: '#2D1B69' }}>
            Trusted by Visionaries in the Social Sector.
          </h2>
          <p className="text-[14px] sm:text-[15px] md:text-[16px] leading-relaxed max-w-[800px] mx-auto px-4" style={{ color: '#3b3b3b' }}>
            Relific isn't just another software provider; we are a partner in the AI transition. Hear from the
            leaders who have swapped weeks of manual compilation for instant, AI-powered insights.
          </p>
        </div>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="flex-shrink-0 self-start sm:self-auto">
                    <svg width="48" height="48" viewBox="0 0 69 69" fill="none" className="sm:w-[56px] sm:h-[56px] md:w-[69px] md:h-[69px]">
                      <path d="M0 69V34.5C0 15.45 15.45 0 34.5 0V13.8C23.115 13.8 13.8 23.115 13.8 34.5H34.5V69H0Z" fill="#D2D6FF"/>
                    </svg>
                  </div>
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    {/* Testimonial Text */}
                    <p className="text-[13px] sm:text-[14px] md:text-[16px] leading-relaxed mb-4" style={{ color: '#1F2937' }}>
                      {testimonials[currentIndex].text}
                    </p>

                    {/* Person Info */}
                    <p className="text-[14px] sm:text-[15px] md:text-[16px] font-semibold" style={{ color: '#1F2937' }}>
        ...
        <div
          className="w-full max-w-[1120px] mx-auto bg-[#E8F4F8] rounded-xl p-6 sm:p-8 md:p-10 lg:p-12 flex flex-col items-center justify-center text-center min-h-[220px] sm:min-h-[240px] md:min-h-[260px]"
        >
          <h3 className="text-[22px] sm:text-[26px] md:text-[32px] font-semibold mb-2 sm:mb-3" style={{ color: '#2D1B69' }}>
            Go AI-Native from Week 1
          </h3>
          <p className="text-[13px] sm:text-[14px] md:text-[16px] mb-5 sm:mb-6 max-w-[600px] px-2" style={{ color: '#4B5563' }}>
            Don't wait months to see results. Upload your MoUs or Proposals and let AI-R build your workflows, KPIs, and trackers automatically.
          </p>
