      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        <div className="text-center">
          ...
          <h2
            ...
            style={{ fontSize: "50px" }}
          >
            Make your impact visible and scale your mission faster.
          </h2>

          {/* Subtext */}
          <p className="text-[#3b3b3b] text-base md:text-lg mb-6 max-w-3xl mx-auto">
            Capture high-fidelity data in any environment and gain the
            intelligence to see your impact in real time.
          </p>
