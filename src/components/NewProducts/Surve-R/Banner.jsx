      ...
      <div className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-2 lg:row-span-2 relative flex justify-center lg:justify-end">
            ...
            >
              <img
                src="/assets/SurveR/Newpage/banner.svg"
                alt="Data Collection Platform Interface"
                width="860"
                height="484"
                fetchPriority="high"
                decoding="async"
          ...
          <div className="order-3 lg:order-3 space-y-6 sm:space-y-8">
            <p
              ...
              style={{ color: "#333333" }}
            >
              Set mandatory fields, range checks, and skip logic all before the
              survey begins. Reach diverse communities in their own
              language-eliminating translation bias and ensuring cleaner data.
            </p>
