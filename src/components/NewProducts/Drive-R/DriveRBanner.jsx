      ...
      <div className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-2 lg:row-span-2 relative flex justify-center lg:justify-end">
            ...
            >
              <img
                src="/assets/drive_r/Newpage/banner.svg"
                alt="Drive R Data Intelligence Platform Interface"
                width="860"
                height="484"
                fetchPriority="high"
                decoding="async"
          ...
          <div className="order-3 lg:order-3 space-y-6 sm:space-y-8">
            <p
              ...
              style={{ color: "#333333" }}
            >
              Connect directly with multiple data sources including your
              external databases. Drive R merges field data, program metrics,
              and global benchmarks into one holistic narrative-no technical
